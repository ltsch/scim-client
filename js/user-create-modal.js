// js/user-create-modal.js - Refactored User Create Modal
...
/**
 * Process schema attributes for user create modal
 */
class UserCreateSchemaAttributeProcessor {
  /**
...
/**
 * Render form fields for user create modal
 */
class UserCreateFormFieldRenderer {
  /**
   * Render text field
...
// ============================================================================
// USER CREATE MODAL RENDERER
// ============================================================================

/**
 * User create modal renderer
 */
class UserCreateModalRenderer {
  /**
   * Create user create modal renderer
   * @param {HTMLElement} container - Container element
  ...
  constructor(container, onSubmit, options = {}) {
    ...
    this.attributes = UserCreateSchemaAttributeProcessor.getEditableAttributes(this.schema);
  ...
  renderFormFields() {
    this.attributes.forEach(attr => {
      const fieldHTML = UserCreateFormFieldRenderer.renderField(attr);
  ...
  async handleSubmit() {
    return await safeAsync(async () => {
      const userData = { schemas: [this.schema.id] };
      const errors = [];
      ...
      this.attributes.forEach(attr => {
        ...
        // Add non-empty values to user data
      ...
      // Submit form
      const result = await this.onSubmit(userData);
      ...
      showSuccess(this.container, 'User created successfully!');
...
/**
 * Render user create modal
 * @param {HTMLElement} container - Container element
 * @param {Function} onSubmit - Submit callback
 * @param {Object} options - Modal options
 */
export function renderUserCreateModal(container, onSubmit, options = {}) {
  return new UserCreateModalRenderer(container, onSubmit, options);
} 